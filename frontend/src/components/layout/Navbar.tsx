...
import { DashboardStatsMenu } from './DashboardStatsMenu';
  ...
  return (
    ...
    <header className="sticky top-4 z-40 px-4 sm:px-8 max-w-7xl mx-auto w-full">
      ...
      <div className="liquid-glass rounded-2xl p-3 px-6 flex items-center justify-between gap-4 border border-[#00ff99]/30 shadow-[0_0_30px_rgba(0,255,153,0.15)]">
        ...
        >
          ...
          <div>
            ...
            <div className="flex items-center gap-1.5">
              ...
              <span className="font-mono font-black text-lg text-[#00ff99] tracking-widest">
                X
              </span>

              <span className="text-[10px] font-mono px-1.5 py-0.5 rounded bg-[#00ff99]/20 text-[#00ff99] border border-[#00ff99]/40">
                AI
              </span>
        ...
        {/* ==================================================
            MAIN ACTION BAR
            Profile → Dashboard → XP → Search → AI Mentor → Menu
        ================================================== */}
              ...
              <div className="absolute top-12 left-0 right-0 bg-[#030303]/95 border border-[#00ff99]/40 rounded-xl p-2 shadow-2xl z-50 space-y-1">
                ...
                {filteredTools.map(tool => (
                  ...
                  >
                    ...
                    <span className="text-[10px] font-mono text-[#7efeff]">
                      {tool.category}
                    </span>
