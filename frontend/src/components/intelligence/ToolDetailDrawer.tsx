      ...
      <div className="fixed inset-y-0 right-0 w-full max-w-xl bg-[#030303]/90 backdrop-blur-2xl border-l border-[#00ff99]/30 z-[9999] shadow-[0_0_50px_rgba(0,255,153,0.2)] flex flex-col transition-all duration-300">
        ...
        <div className="flex-1 overflow-y-auto p-6 space-y-6">
          {activeTab === 'info' && (
            <>
              <div>
                <h4 className="text-xs font-mono uppercase text-[#00ff99] tracking-wider mb-2">Overview</h4>
                <p className="text-sm text-slate-300 leading-relaxed font-sans">{tool.description}</p>
              </div>
              <div>
                <h4 className="text-xs font-mono uppercase text-[#00ff99] tracking-wider mb-2">Primary Purpose</h4>
                <p className="text-sm text-slate-300 leading-relaxed font-sans">{tool.purpose}</p>
              </div>
              <div>
                <h4 className="text-xs font-mono uppercase text-[#00ff99] tracking-wider mb-2">When to Use</h4>
                <p className="text-sm text-slate-300 leading-relaxed font-sans">{tool.whenToUse}</p>
              </div>
              <div>
                <h4 className="text-xs font-mono uppercase text-[#00ff99] tracking-wider mb-2">Key Advantages</h4>
                <ul className="space-y-1.5">
                  {tool.advantages.map((adv, idx) => (
                    <li key={idx} className="text-sm text-slate-300 flex items-start gap-2">
                      <span className="text-[#00ff99] mt-1 font-bold">•</span>
                      <span>{adv}</span>
                    </li>
                  ))}
                </ul>
              ...
              <div>
                <h4 className="text-xs font-mono uppercase text-[#00ff99] tracking-wider mb-2">Lessons Included</h4>
